          ...
          <tbody className="">
            <tr className="border dark:border-violet-900">
              ...
              <td className="px-6 py-4 ">
                <button
                  className="p-1 dark:text-white text-white bg-blue-700 rounded-md hover:bg-blue-800"
                  onClick={() =>
        ...
        <div className="bg-white modal-box dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 ">
            <div className="inline-flex items-center">
              ...
              <p className="text-gray-900  text-[14px] text-center dark:text-green-500  p-2">
                10/6/2024
              </p>
            </div>
            <div className="inline-flex items-center">
              ...
              <p className="text-gray-900  text-[14px] text-center dark:text-red-500  p-2">
                15/6/2024
              </p>
            </div>
            <div className="inline-flex items-center">
